...
import { buildAgentMainSessionKey, parseAgentSessionKey } from "./compat/routing/session-key.js";
              ...
              <div class="sidebar-brand">
                ${
                  navCollapsed
                    ? nothing
                    : html`
                        <img class="sidebar-brand__logo" src="${agentLogoUrl(basePath)}" alt="ColarCore" />
                        <span class="sidebar-brand__copy">
                          <span class="sidebar-brand__eyebrow">${t("nav.control")}</span>
                          <span class="sidebar-brand__title">ColarCore</span>
                        </span>
                      `
                }
              </div>
